...
import { BiData, BiMoneyWithdraw, BiUserCircle } from "react-icons/bi";
...
const items: MenuItem[] = [
  ...
  getItem("Configurações", "sub6", <MdSettings size={20} />, [
    getItem(
      <a href="/log/" className="menu">
        Log
      </a>,
      "conf01",
      <BiData size={20} />
    ...
    <div>
      ...
      >
        <Menu
          ...
          defaultOpenKeys={["sub2", "sub3", "sub4", "sub5", "sub6"]}
          items={items}
        />
      </Layout.Sider>
    </div>
